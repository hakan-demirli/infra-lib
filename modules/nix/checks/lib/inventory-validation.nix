...
let
  ...
  cases = {
    duplicate-id = {
      desc = "two TOMLs with the same `id` field throw";
      expectFail = true;
      files = {
        "users/alpha.toml" = validUser "shared";
        "users/beta.toml" = lib.replaceStrings [ ''id = "shared"'' ] [ ''id = "shared"'' ] (
          builtins.replaceStrings [ ''username = "shared"'' ] [ ''username = "beta-acct"'' ] (
            validUser "shared"
          )
        );
      };
    ...
    missing-id = {
      desc = "TOML without an `id` field throws";
      expectFail = true;
      files = {
        "users/orphan.toml" = ''
          kind = "human"
    ...
    basename-mismatch = {
      ...
      expectFail = true;
      files = {
        "users/wrong.toml" = validUser "right";
      };
    };
    ...
    host-class-personal-no-owner = {
      ...
      expectFail = true;
      files = {
        "users/u-test.toml" = validUser "u-test";
        "roles/r-test.toml" = validRole "r-test";
        "teams/t-test.toml" = ''
          id = "t-test"
          ...
          role = "member"
        '';
        "hosts/personal/h-personal.toml" = ''
          id = "h-personal"
          roles = ["r-test"]
          state = "provisioned"
    ...
    switch-port-unknown-peer = {
      ...
      files = {
        ...
        '';
        "networks/net-mgmt.toml" = ''
          id = "net-mgmt"
          kind = "mgmt"
          cidr_v4 = "10.0.0.0/24"
        '';
        "switches/sw-test.toml" = ''
          id = "sw-test"
